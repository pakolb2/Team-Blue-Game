...
import pandas as pd
import numpy as np
from game_init import *  # Importing all functions from game_init.py, you can specify which functions to import if you want to avoid namespace pollution.
from gamplay_functions import *  # Importing all functions from gamplay_functions.py, you can specify which functions to import if you want to avoid namespace pollution.
...
def main():
    ...
    if input ("Do you want to initialize players and teams? (y/n): ").lower() == "y":
        ...
        players = ["Alice", "Bob", "Charlie", "David"]  # Replace with Player objects when you have a Player class defined.
